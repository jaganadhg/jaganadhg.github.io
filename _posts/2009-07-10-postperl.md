...
tags: [POS Tagging, Natural Language Processing]
use_math: true
comment: true
---
...
There is Pertl module available in the [CPAN](http://search.cpan.org/) site called [Lingua::EN::Tagger](http://search.cpan.org/~acoburn/Lingua-EN-Tagger-0.15/Tagger.pm) . It is a tagger module for English and some other Europian Languages. Let us see how it can be used for POS Tagging.
